...
def generate_feed_item(
    ...
    """
    # Only generate for active or monitored companies meeting score threshold
    if company.status in (CompanyStatus.DISQUALIFIED,):
        return None
...
def run_feed_generation_for_workspace(
    ...
    companies = (
        ...
        .filter(
            ...
            Company.composite_score >= icp.watch_score_threshold,
            Company.status.in_([CompanyStatus.ACTIVE, CompanyStatus.MONITORING]),
        )
