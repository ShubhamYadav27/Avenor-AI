...
from app.models import (
    SignalType, BuyingWindowLabel, CompanyStatus,
)
...
class TestScoreCompany:
    def test_no_signals_returns_zero_score(self):
        ...
        assert result["buying_window"] in (BuyingWindowLabel.COLD.value, BuyingWindowLabel.WATCH.value, "monitoring")
    ...
    def test_strong_signals_full_icp_produces_high_score(self):
        ...
        result = score_company(company, signals, [opp], [], icp, DEFAULT_SIGNAL_WEIGHTS)
