export default function Page() {
  return (
    <div className="w-full min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
      <h1 className="text-5xl font-bold mb-6 capitalize">integrations</h1>
      <p className="text-xl text-white/50 max-w-2xl mx-auto mb-10">
        Detailed documentation and product capabilities for integrations are actively being migrated to this enterprise portal.
      </p>
